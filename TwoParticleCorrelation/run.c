...
void scan(TString filename = "/data/flowex/CMSsample/TPCNtuple_MinBias_TuneCUETP8M1_5p02TeV-pythia8-HINppWinter16DR-NoPU_75X_mcRun2_asymptotic_ppAt5TeV_forest_v2_track.root",TString savename = "TPCNtuple_MinBias_TuneCUETP8M1_5p02TeV-pythia8-HINppWinter16DR-NoPU_75X_mcRun2_asymptotic_ppAt5TeV_forest_v2_track",Int_t isGen = 0,Int_t isThrust = 0)
{
...
void run()
{
    ...
    scan(pthat1_Zee,pthat1_Zee_save,1,1);
    ...
    scan(pthat1_Zee_RopeWalk,pthat1_Zee_RopeWalk_save,1,1);
    ...
    scan(pthat1_Zee_minNPart60,pthat1_Zee_minNPart60_save,1,1);
    ...
    scan(pthat1_Zee_RopeWalk_minNPart60,pthat1_Zee_RopeWalk_minNPart60_save,1,1);
