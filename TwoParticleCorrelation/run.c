...
void run(     TString filename = "aaa",
	      ...
	      int maxevt       = 10000000,	// Max number of events to be processed, 0 = all events
	      int mult_low     = 50,		// Lower cut on the event multiplicity
	      ...
	      int num_runs     = 10,		// 
              double ptMin     = 1,           // min pT of the particles used for correlation function
              double ptMax     = 100,             // max pT of the particles used for correlation function
              double detaRange  =3,             // deta window of the correlation function
