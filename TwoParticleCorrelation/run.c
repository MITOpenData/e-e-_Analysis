...
void scan(TString filename = "/data/flowex/CMSsample/TPCNtuple_MinBias_TuneCUETP8M1_5p02TeV-pythia8-HINppWinter16DR-NoPU_75X_mcRun2_asymptotic_ppAt5TeV_forest_v2_track.root",TString savename = "TPCNtuple_MinBias_TuneCUETP8M1_5p02TeV-pythia8-HINppWinter16DR-NoPU_75X_mcRun2_asymptotic_ppAt5TeV_forest_v2_track")
{
    ...
    for (int i=0;i<4;i++)
    {
        ...
        analysis(filename,savename, 0, 0, 0, 1000000,mult_low[i],mult_high[i],20,0,5,0,4.0,3.2,0.4,100,2.4);
    }
}
...
void run()
{
    ...
    scan(pthat1_Zee,pthat1_Zee_save);
    ...
    scan(pthat1_Zee_RopeWalk,pthat1_Zee_RopeWalk_save);
