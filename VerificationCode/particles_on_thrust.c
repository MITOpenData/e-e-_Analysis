...
void analysis(int maxevt=10){
  ...
  TString filename="/mnt/c/Users/Bibek Kumar Pandit/Desktop/Root_Directory/StudyMult/VerificationCode/new_mult_data.root";
  ...
  */
  ...
  hprojection[i]=new TH2F(Form("hprojection%d",i),Form("Particles on top of Thrust Contour Plot (Event: %d)",i),nstepstheta,mintheta,maxtheta,nstepsphi,minphi,maxphi);
