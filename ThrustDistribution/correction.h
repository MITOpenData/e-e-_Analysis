...
hist* correct_thrust(hist* h)
{
	...
	Double_t bins[] = {.6,.65,.7,.75,.8,.82,.84,.86,.88,.9,.92,.94,.95,.96,.965,.97,.975,.98,.985,.99,.995,1};
	Double_t corrs[] = {1.054,0.910,1.013,0.944,1.055,1.034,1.100,1.105,1.070,1.079,1.104,1.104,1.083,1.096,1.048,1.055,1.007,0.926,0.803,0.664,0.425};
	Double_t errs[] = {.192,.053,.040,.027,.041,.034,.034,.030,.023,.018,.022,.019,.023,.021,.019,.019,.016,.016,.016,.022};
