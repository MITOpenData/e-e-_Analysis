...
#include "src/thrust_distribution.c"

void thrust_vs_hep(TString thrust_file = "~/Downloads/StudyMult/TwoParticleCorrelation/alephDataPaths_LEP1.root", TString hep_file = "~/Downloads/HEPData-ins636645-v1-Table54.root")
{
