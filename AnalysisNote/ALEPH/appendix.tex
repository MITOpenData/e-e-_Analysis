\section{Appendix}
Cross check for two particle correlation plots. The cuts are specified in Table 1 and 2. The first column contains Anthony's analysis, the second contains Austin's cross-check, and the third contains the ratio of the two.
%%%%%%%%%%% LEP1 %%%%%%%%%%%
\begin{figure}[H]
\centering
