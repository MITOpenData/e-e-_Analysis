...
\title{Two-Particle Correlation Analysis with ALEPH Data}
\author{Yen-Jie Lee}
...
\subsection{LEP 1}
\begin{figure}[!htb]
\includegraphics[width=.4\textwidth]{plots/GlobalObservables/LEP1/allmomlep1.pdf}
\caption{Momentum of all particles, charged hadrons, and neutral hadrons+photons in LEP 1.}
\label{fig:allmomlep1} 
\end{figure}

\begin{figure}[htb]
\includegraphics[width=.4\textwidth]{plots/GlobalObservables/LEP1/allmultlep1.pdf}
\caption{Multiplicity of all particles, charged hadrons, and neutral hadrons+photons in LEP 1.}
\label{fig:allmultlep1} 
\end{figure}


\begin{figure}[htb]
\includegraphics[width=.4\textwidth]{plots/GlobalObservables/LEP1/jetetalep1.pdf}
\caption{Jet eta distribution in LEP 1.}
\label{fig:jetetalep1} 
\end{figure}

\begin{figure}[htb]
\includegraphics[width=.4\textwidth]{plots/GlobalObservables/LEP1/jetptlep1.pdf}
\caption{Jet pt distribution in LEP 1.}
\label{fig:jetptlep1} 
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{LEP1 Monte-Carlo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{LEP 2}
\begin{figure}[bp!]
\includegraphics[width=.45\textwidth]{plots/GlobalObservables/LEP2/allmomlep2.pdf}
\caption{Momentum of all particles, charged hadrons, and neutral hadrons+photons in LEP 2.}
\label{fig:allmomlep2} 
\end{figure}

\begin{figure}[bp!]
\includegraphics[width=.45\textwidth]{plots/GlobalObservables/LEP2/allmultlep2.pdf}
\caption{Multiplicity of all particles, charged hadrons, and neutral hadrons+photons in LEP 2.}
\label{fig:allmultlep2} 
\end{figure}


\begin{figure}[bp!]
\includegraphics[width=.45\textwidth]{plots/GlobalObservables/LEP2/jetetalep2.pdf}
\caption{Jet eta distribution in LEP 2.}
\label{fig:jetetalep2} 
\end{figure}

\begin{figure}[bp!]
\includegraphics[width=.45\textwidth]{plots/GlobalObservables/LEP2/jetptlep2.pdf}
\caption{Jet pt distribution in LEP 2.}
\label{fig:jetptlep2} 
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
