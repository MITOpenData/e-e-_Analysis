...
class Sphericity{
  ...
  public:
    Sphericity(int n, float *px, float *py, float *pz, Char_t *pwflag, bool onlyCharged = true);
    ~Sphericity();
  ...
  private:
    ...
    void calculateSphericity(int n, float *px, float *py, float *pz, Char_t *pwflag, float r);
...
void Sphericity::calculateSphericity(int n, float *px, float *py, float *pz, Char_t *pwflag, float r){
  float norm = 0;
...
Sphericity::Sphericity(int n, float *px, float *py, float *pz, Char_t *pwflag, bool onlyCharged){
  l1 = -99;
  l2 = -99;
  l3 = -99;
  v1 = TVector3(0,0,0);
