#ifndef PARTICLEDATAOLD_H
#define PARTICLEDATAOLD_H
...
particleDataOLD::particleDataOLD()
{
...
void particleDataOLD::SetStatusAndAddressRead(TTree* inTree_p, std::vector<std::string> inList)
{
  if(inList.size() != 0){
...
void particleDataOLD::SetBranchWrite(TTree* inTree_p)
{
...
void particleDataOLD::preFillClean()
{
