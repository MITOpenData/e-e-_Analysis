...
int sigMixThrustComp(const std::string inFileName1, const std::string inFileName2)
{
  ...
  */
  ...
  const Int_t nAbsEtaBins = 21;
  Double_t absEtaBins[nAbsEtaBins+1] = {0.0, 0.200, 0.400, 0.600, 0.800, 1.000, 1.200, 1.400, 1.600, 1.800, 2.000, 2.200, 2.400, 2.600, 2.800, 3.000, 3.200, 3.400, 3.600, 3.800, 4.0, 10.};
