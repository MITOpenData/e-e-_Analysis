...
into bins in the hadron multiplicity. For each hadron multiplicity class, ``trigger" particles are defined as charged hadrons in the selected transverse momentum range (0.1 and 4.0 GeV/$c$). In the full data analysis, a matching between particle and the primary vertex should be performed which is not yet included in this analysis due to the limited information in the open data. %particles originating  from primary vertex
The number of trigger particles in the event is denoted
